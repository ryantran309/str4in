...
function SideBarNoWs() {
  ...
  function add_workspace(e) {
    e.preventDefault();
    axios
      .post(`${SERVER_URI}/workspace/add_workspace`, { name: workspace_field })
      .then((res) => {
        if (res.data.status) {
  ...
  function workspace_handler(id) {
    ...
    document
      .getElementById("workspace_" + workspace_class)
  ...
  function toggleSideBar(e) {
    e.preventDefault();
    const sideBar = e.currentTarget.parentElement.parentElement.parentElement;
